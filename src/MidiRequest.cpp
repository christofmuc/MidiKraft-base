...
namespace midikraft {
	...
	midikraft::MidiRequest::MidiRequest(juce::MidiDeviceInfo const &midiOutput, MidiMessage const &request, TIsAnswerPredicate pred) : output_(midiOutput), request_(request), pred_(pred)
	{
	}
